...
- 这套操作，是我用了几年的，你跟着做，保证没有问题，没有任何费用。
  - 但是如果你对技术很抵触，自己配置不了，你可以添加我的微信：hdylw1024，我远程给你配置，但是以下有两个条件，我先说明一下：
    - 你的电脑必须安装好Teamviewer，下载地址：https://www.teamviewer.com/en/download/windows/
    - 我要收取时间成本，66元/次，你加我后，直接转账，我有时间就收费然后和你约一个彼此都方便的时间就好~15分钟左右，配置完成。（我没时间或者配置过程中有意外问题，比如你那里的网其实是限制的，我就直接退费，咱们就免客套，年底都很忙~~~互相理解。）
